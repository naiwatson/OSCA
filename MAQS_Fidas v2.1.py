...
month_start = 3 #input the month of study
...
start_Audit8 = datetime.datetime(2022,5,4,10,50,00) #next audit
end_Audit8 = datetime.datetime(2022,5,4,11,0,00)
...
end_filter_change = datetime.datetime(2022,5,4,9,0,00)
...
fidas_PM.to_csv(str(fidas_Folder) + 'maqs-fidas-PM_' + str(date_file_label) + '_' + str(datatype) + '_' + str(version_number) + '.csv')
fidas_Met.to_csv(str(fidas_Folder) + 'maqs-fidas-Met_' + str(date_file_label) + '_' + str(datatype) + '_' + str(version_number) + '.csv')
