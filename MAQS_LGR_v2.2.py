...
pattern = str(LGR_Cal_Data_Source) + '1_Overall_LGR_Calibrations*' + str(version_number) + '.csv'# Needs to be address of data location - Collect CSV files
...
LGR_Cal['MultiCarbon_Cal'] = np.where((LGR_Cal['NH3_Intercept'].isnull()), True, False) 
LGR_Cal['Ammonia_Cal'] = np.where((LGR_Cal['CH4_Intercept'].isnull()), True, False)
GHG_Cal = LGR_Cal[['datetime', 'CH4_Intercept', 'CH4_Slope', 'CO2_Intercept', 'CO2_Slope', 'CO_Intercept', 'CO_Slope', 'MultiCarbon_Cal']]
GHG_Cal.drop(GHG_Cal[(GHG_Cal['MultiCarbon_Cal'] == False)].index,inplace =True) 
Ammonia_Cal = LGR_Cal[['datetime', 'NH3_Intercept','NH3_Slope', 'Ammonia_Cal']]
Ammonia_Cal.drop(Ammonia_Cal[(Ammonia_Cal['Ammonia_Cal'] == False)].index,inplace =True)
...
GHG_Data['CH4 a'] = np.interp(GHG_Data['datetime'], GHG_Cal['datetime'], GHG_Cal['CH4_Intercept']) # interpolate the zero values
GHG_Data['CH4 b'] = np.interp(GHG_Data['datetime'], GHG_Cal['datetime'], GHG_Cal['CH4_Slope']) #
GHG_Data['CH4 (ppm) perlim']=np.nan
GHG_Data['CH4 (ppm) perlim'] = (GHG_Data['CH4 (ppm)']*GHG_Data['CH4 b']) + GHG_Data['CH4 a']

GHG_Data['CO2 a'] = np.interp(GHG_Data['datetime'], GHG_Cal['datetime'], GHG_Cal['CO2_Intercept']) # interpolate the zero values
GHG_Data['CO2 b'] = np.interp(GHG_Data['datetime'], GHG_Cal['datetime'], GHG_Cal['CO2_Slope']) #
GHG_Data['CO2 (ppm) perlim']=np.nan
GHG_Data['CO2 (ppm) perlim'] = (GHG_Data['CO2 (ppm)']*GHG_Data['CO2 b']) + GHG_Data['CO2 a']

GHG_Data['CO a'] = np.interp(GHG_Data['datetime'], GHG_Cal['datetime'], GHG_Cal['CO_Intercept']) # interpolate the zero values
GHG_Data['CO b'] = np.interp(GHG_Data['datetime'], GHG_Cal['datetime'], GHG_Cal['CO_Slope']) #
...
GHG_Data.to_csv(str(LGR_Folder) + 'maqs-CH4-H2O-CO2-CO-concentration_' + str(date_file_label)  + str(status) +  str(version_number) + '.csv')
...
#Ammonia_Data.to_csv(str(Data_Output_Folder) + 'maqs-NH3_Analyser-concentration_' + str(date_file_label) + '_' + str(version_number) + '.csv')
...
Ammonia_Data.to_csv(str(LGR_Folder) + 'maqs--NH3-H2O-concentration_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
