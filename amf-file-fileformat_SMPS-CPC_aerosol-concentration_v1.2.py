...
dataset_out = nc.Dataset(direct + 'maqs-SMPS_' + str(current_SMPS_model) + '-CPC_' + str(current_CPC_model) + '-1_20' + str(date_file_label) + '_aerosol-concentration' + str(status) + str(version_number) + '.nc', 'w', format='NETCDF4_CLASSIC')
...
print(smps['second'].min())
print(smps['second'].max())
...
total_number_concentration_of_ambient_aerosol_particles_in_air.practical_units ='kPa'
...
print(direct + 'maqs-SMPS_' + str(current_SMPS_model) + '-CPC_' + str(current_CPC_model) + '-1_20' + str(date_file_label) + '_aerosol-concentration' + str(status) + str(version_number))
