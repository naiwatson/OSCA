...
month_start = 4 #input the month of study
...
#early_Data.to_csv(str(Data_Output_Folder) + 'Early_Data_' + str(date_file_label) + '_' + str(version_number) + '.csv')
...
#all_Data.to_csv(str(Data_Output_Folder) + 'All_Data_' + str(date_file_label) + '_' + str(version_number) + '.csv')
...
NOy_Data.to_csv(str(gas_Folder) + 'maqs-nox-noxy-concentration' + str(status) + str(date_file_label) + '_' + str(version_number) + '.csv')
...
NO2_Data.to_csv(str(gas_Folder) + 'maqs-NO2-concentration' + str(status) + str(date_file_label) + '_' + str(version_number) + '.csv')
...
ozone_Data.to_csv(str(gas_Folder) + 'maqs-O3-concentration' + str(status) + str(date_file_label) + '_' + str(version_number) + '.csv')
...
if start_year_month_str > '202002':
    ...
    CO_Data.drop(CO_Data[(CO_Data['CO (ppb)'].isnull())].index,inplace =True)
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags']=='8C040000'), 1, CO_Data['CO Flags'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['All_Data_Flag']== 2), 2, CO_Data['CO_Prelim_Flag'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['All_Data_Flag']== 0), 0, CO_Data['CO_Prelim_Flag'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags']=='FFFFFFFF'), 0, CO_Data['CO_Prelim_Flag'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags'].isnull() ), 0, CO_Data['CO_Prelim_Flag'])
    ...
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags']=='8C050000'), 0, CO_Data['CO_Prelim_Flag'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags']=='8C050400'), 0, CO_Data['CO_Prelim_Flag'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags']=='8C070000'), 0, CO_Data['CO_Prelim_Flag'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags']=='8C070001'), 0, CO_Data['CO_Prelim_Flag'])
    CO_Data['CO_Prelim_Flag'] = np.where((CO_Data['CO Flags']=='8C074000'), 0, CO_Data['CO_Prelim_Flag'])
    ...
    CO_Data.to_csv(str(gas_Folder) + 'maqs-CO-concentration_' + str(date_file_label) +  str(status) + str(version_number) + '.csv')
