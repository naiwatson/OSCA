...
#xact_Raw_Data_csv.to_csv(str(Data_Output_Folder) + 'maqs-XACT-Collective_PM_metal_concentration_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')

#xact_Data_csv.drop(columns=['Upscale_flag'], inplace=True)
...
#xact_Data_csv.drop(columns=['PM_flag', 'PM Valve'], inplace=True)
#xact_Data_csv.to_csv(str(XACT_Folder) + 'maqs-XACT-metal_concentration_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
...
#xact_flags.to_csv(str(Data_Output_Folder) + 'maqs-XACT-PM_Metal_Flags_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
...
#xact_Data_uncert.to_csv(str(Data_Output_Folder) + 'maqs-XACT-PM_Metal_Uncert_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
...
#xact_Data_only.to_csv(str(Data_Output_Folder) + 'maqs-XACT-PM_Metal_Data_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')

xact_Data_csv = pd.concat([xact_Data_only, xact_Data_uncert, xact_flags])
#xact_Data_csv.to_csv(str(Data_Output_Folder) + 'maqs-XACT-Collective_PM_metal_concentration_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
...
#xact_Data_csv = xact_Data_csv.reindex(sorted(xact_Data_csv.columns), axis=1)
#xact_Data_csv.to_csv(str(Data_Output_Folder) + 'maqs-XACT-Collective_PM_metal_concentration_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
#xact_PM2p5_csv.to_csv(str(Data_Output_Folder) + 'maqs-XACT-PM_2.5_metal_concentration_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
#xact_PM10_csv.to_csv(str(Data_Output_Folder) + 'maqs-XACT-PM_10_metal_concentration_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
...
if int(start_year_month_str) < 202012: 
    xact_PM10_csv.to_csv(str(XACT_Full_Folder) + 'maqs-XACT-PM_10_full_elemental_composition-' + str(date_file_label)  + str(status) + str(version_number) + '.csv') 
    #xact_Data_csv.to_csv(str(XACT_Full_Folder) + 'maqs-XACT-Collective_PM_full_elemental_composition_' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
else:
    xact_PM2p5_csv.to_csv(str(XACT_Full_Folder) + 'maqs-XACT-PM_2.5_full_elemental_composition-' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
    xact_PM10_csv.to_csv(str(XACT_Full_Folder) + 'maqs-XACT-PM_10_full_elemental_composition-' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
    xact_Data_csv.to_csv(str(XACT_Full_Folder) + 'maqs-XACT-Collective_PM_full_elemental_composition-' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
...
if int(start_year_month_str) < 202012: #Elemental Composition
    xact_PM10_csv.to_csv(str(XACT_Folder) + 'maqs-XACT-elemental_composition_of_PM10_aerosols-' + str(date_file_label)  + str(status) + str(version_number) +  '.csv') 
else:
    ...
    xact_PM2p5_csv.to_csv(str(XACT_Folder) + 'maqs-XACT-elemental_composition_of_PM2.5_aerosols-' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
    xact_PM10_csv.to_csv(str(XACT_Folder) + 'maqs-XACT-elemental_composition_of_PM10_aerosols-' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
    xact_Data_csv.to_csv(str(XACT_Collective_Folder) + 'maqs-XACT-elemental_composition_of_both_PM10_and_PM2.5_aerosols-' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
...
xact_Cal_csv.to_csv(str(XACT_Cal_Folder) + 'maqs-XACT_625i-Collective_Cal_file-' + str(start.strftime("%Y")) + str(start.strftime("%m")) + str(status) + str(version_number) + '.csv')
