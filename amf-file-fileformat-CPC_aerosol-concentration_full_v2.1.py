...
elif float(start_year_month_str) == 202102 or float(start_year_month_str) == 202110 or float(start_year_month_str) == 202111 or float(start_year_month_str) == 202112:
    pass
else:
...
dataset_out = nc.Dataset(direct + 'maqs-CPC-' + str(current_instrument_model) + '-1_' + str(date_file_label) + '_aerosol-concentration' + str(status) + str(version_number) + '.nc', 'w', format='NETCDF4_CLASSIC')
