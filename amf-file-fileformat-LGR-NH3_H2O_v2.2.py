...
dataset_out = nc.Dataset(direct + 'maqs-lgr_ammonia_analyser-1_' + str(date_file_label) + '_NH3-H2O_concentration' + str(status) + str(version_number) + '.nc', 'w', format='NETCDF4_CLASSIC')
