...
year_start = 2020 #input the year of study by number
...
smps['qc_Flags'] = np.where( smps['Number Concentration of Ambient Aerosol Particles in air (##/cm^3)']>30000, "2", smps['qc_Flags'])
...
smps.to_csv(str(smps_Folder) + 'maqs-SMPS-CPC_aerosol-size-distribution_20' + str(date_file_label)  + str(status) + str(version_number) + '.csv')
