...
dataset_out = nc.Dataset(direct + 'maqs-XACT_625i-1_' + str(date_file_label) + '-elemental_composition_of_pm2p5_aerosols' + str(status) + str(version_number) + '.nc', 'w', format='NETCDF4_CLASSIC')
