...
year_start = 2021 #input the year of study by number
...
if int(start_year_month_str) == 202110 or int(start_year_month_str) == 202111 or int(start_year_month_str) == 202112:
...
if Total_CPC_2_Model == 'N/A' or Total_CPC_1_Model == 'N/A' or Total_CPC_1_Model == Total_CPC_2_Model or int(start_year_month_str) == 202112 :
    ...
    #Intercomparison_CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '_particle-concentration' + str(status) + str(version_number) + '.csv')


#CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '_particle-concentration' + str(status) + str(version_number) + '.csv')
...
start_Flow_Error_1 = datetime.datetime(2020,4,15,12,15,00) #pulse height too high
...
if int(start_year_month_str) < 201906:
    ...
    plt.figure()
    plt.show()
    CPC_Data.to_csv(str(Simon_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + str(location_input)  + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    ...
    Simon_CPC_Data.to_csv(str(Simon_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + str(location_input)  + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Firs_CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    ...
    #plt.figure()
    plt.show()
    CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '01-to-' + str(date_file_label) + '10' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Total_CPC_2_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '10-to-' + str(date_file_label) + '28' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Intercomparison_CPC_Data.to_csv(str(Compare_CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '10-to-' + str(date_file_label) + '12' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    ...
    plt.show()
    CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Intercomparison_CPC_Data.to_csv(str(Compare_CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '_particle-concentration' + str(status) + str(version_number) + '.csv')
elif int(start_year_month_str) == 202110:
    plt.plot(CPC_Data['Conc (#/cc)'], label='Particle Number count in upper position for CPC: ' + str(Total_CPC_1_Model))
    plt.plot(Intercomparison_CPC_Data['Conc (#/cc)'], label='Particle Number count in lower position for CPC: ' + str(Total_CPC_2_Model))
    ...
    #plt.figure()
    plt.show()
    CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '01-to-' + str(date_file_label) + '27' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Intercomparison_CPC_Data.to_csv(str(Compare_CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '01-to-' + str(date_file_label) + '27' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Total_CPC_2_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '27-to-' + str(date_file_label) + '31' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Intercomparison_CPC_2.to_csv(str(Compare_CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '27-to-' + str(date_file_label) + '31' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
elif int(start_year_month_str) == 202111:
    ...
    CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '01-to-' + str(date_file_label) + '10' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Intercomparison_CPC_Data.to_csv(str(Compare_CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '01-to-' + str(date_file_label) + '10' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Total_CPC_2_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '10-to-' + str(date_file_label) + '30' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
elif int(start_year_month_str) == 202112:
    ...
    CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_1_Model) + '-1_' + str(date_file_label) + '01-to-' + str(date_file_label) + '09' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
    Total_CPC_2_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_2_Model) + '-1_' + str(date_file_label) + '09-to-' + str(date_file_label) + '31' + '_particle-concentration' + str(status) + str(version_number) + '.csv')
else:
    ...
    CPC_Data.to_csv(str(CPC_Folder) + 'maqs-CPC-' + str(Total_CPC_Model_No) + '-1_' + str(date_file_label) + '_particle-concentration' + str(status) + str(version_number) + '.csv')
...
if int(start_year_month_str) == 202102 or int(start_year_month_str) == 202110 or int(start_year_month_str) == 202111 or int(start_year_month_str) == 202112:
